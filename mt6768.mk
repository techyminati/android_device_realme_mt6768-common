...
COMMON_PATH := device/realme/mt6768-common

# Installs gsi keys into ramdisk, to boot a GSI with verified boot.
$(call inherit-product, $(SRC_TARGET_DIR)/product/gsi_keys.mk)

# Call proprietary blob setup
$(call inherit-product-if-exists, vendor/realme/mt6768-common/mt6768-common-vendor.mk)
...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/audio/audio_policy_configuration.xml:$(TARGET_COPY_OUT_ODM)/etc/audio_policy_configuration.xml
...
# Lights
PRODUCT_PACKAGES += \
    android.hardware.light@2.0-service.realme_mt6768
